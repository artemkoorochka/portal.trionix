...
if(typeof(BX.CrmHistory) === "undefined")
{
	...
	BX.CrmHistory.prototype.refreshLayout = function()
	{
		...
		if(this._items[length - 1] != undefined){
...
if(typeof(BX.CrmHistoryItemScoring) === "undefined")
{
	...
	BX.CrmHistoryItemScoring.prototype.prepareContent = function()
	{
		...
		var icon = BX.create("DIV",
			{
				attrs: { className: "crm-entity-stream-content-scoring-total-icon crm-entity-stream-content-scoring-total-icon-success" }
			}
			);
									...
									BX.create("DIV",
										{
											...
											text: BX.message("CRM_TIMELINE_SCORING_TITLE")
										}
									),
									result,
									icon
