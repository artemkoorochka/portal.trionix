				...
				<div id="<?=htmlspecialcharsbx($smsContainerID)?>" class="crm-entity-stream-content-new-detail focus" style="display: none;">
					...
					<div class="crm-entity-stream-content-new-sms-btn-container">
						...
						{?>
							<div class="crm-entity-stream-content-sms-salescenter-container-absolute" data-role="salescenter-starter">
								...
								<div class="crm-entity-stream-content-sms-salescenter-text"><?=GetMessage('CRM_TIMELINE_SMS_SALESCENTER_STARTER')?></div>
							</div>
							<?php
						}
						?>
					...
					<div class="crm-entity-stream-content-sms-conditions-container">
						<div class="crm-entity-stream-content-sms-conditions">
							<?php if($arResult['ENABLE_SALESCENTER'])
							{?>
								<div class="crm-entity-stream-content-sms-salescenter-container" data-role="salescenter-starter">
									<div class="crm-entity-stream-content-sms-salescenter-icon"></div>
									<div class="crm-entity-stream-content-sms-salescenter-text"><?=GetMessage('CRM_TIMELINE_SMS_SALESCENTER_STARTER')?></div>
								</div>
								<?php
			...
			<div class="crm-entity-stream-filter-container">
				...
				$APPLICATION->includeComponent(
					...
					array(
						...
						'LAZY_LOAD' => array(
							'GET_LIST' => '/bitrix/components/trionix/crm.timeline/filter.ajax.php?action=list&filter_id='.urlencode($arResult['HISTORY_FILTER_ID']).'&siteID='.SITE_ID.'&'.bitrix_sessid_get(),
							'GET_FIELD' => '/bitrix/components/trionix/crm.timeline/filter.ajax.php?action=field&filter_id='.urlencode($arResult['HISTORY_FILTER_ID']).'&siteID='.SITE_ID.'&'.bitrix_sessid_get(),
						)
					)
				);
				?>
	...
	BX.ready(
		function()
		{
			...
			BX.message({
				...
				"CRM_TIMELINE_SCORING_TITLE": '<?=GetMessageJS("CRM_TIMELINE_SCORING_TITLE")?>'
			});
			...
			BX.CrmTimelineManager.create(
				"<?=CUtil::JSEscape($guid)?>",
				{
					...
					serviceUrl: "/bitrix/components/trionix/crm.timeline/ajax.php?&site=<?=SITE_ID?>&<?=bitrix_sessid_get()?>",
